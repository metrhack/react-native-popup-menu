    ...
    _createClass(Backdrop, [{
      ...
      value: function componentWillUnmount() {
        ...
        if (this.contextMenuEvent) {
          var event = this.contextMenuEvent;
          var clientX = event.clientX,
              clientY = event.clientY; // Use setTimeout to delay the execution of the code
      ...
      value: function close() {
        ...
        return new Promise(function (resolve) {
          reactNative.Animated.timing(_this4.fadeAnim, {
      ...
      value: function onContextMenu(e) {
        ...
        e.preventDefault();
        e.stopPropagation();
        this.props.onPress(); // Create a new event to bubble up
        ...
        var backdropEl = e.target.parentElement;
      ...
      value: function render() {
        ...
        return React__default.createElement(reactNative.Pressable, {
          style: [styles.fullscreen, styles.noCursor],
          onPress: onPress,
          onContextMenu: this.onContextMenu
        }, React__default.createElement(reactNative.Animated.View, {
          style: [styles.fullscreen, styles.initialOpacity, {
            opacity: this.fadeAnim
          }]
        }, React__default.createElement(reactNative.View, {
          style: [styles.fullscreen, styles.initialOpacity, style]
        })));
      }
    }]);
